  ...
  return (
    <div className="flex items-center justify-center">
      <div className="w-full container mx-auto p-6">
        ...
        <h2 className="text-xl font-semibold text-pink-500 mt-6 mb-3">Use of Service</h2>
        ...
        <h2 className="text-xl font-semibold text-pink-500 mt-6 mb-3">User Responsibilities</h2>
        <ul className="list-disc pl-6 text-gray-700 mb-4">
          <li>You are responsible for maintaining the confidentiality of your account and password.</li>
          <li>Notify us immediately of any unauthorized use of your account.</li>
        </ul>
        <h2 className="text-xl font-semibold text-pink-500 mt-6 mb-3">Limitation of Liability</h2>
        <p className="text-gray-700 mb-4">
          Sukaii Health is not liable for any indirect, incidental, or consequential damages arising from your use of our services.
        </p>
        <h2 className="text-xl font-semibold text-pink-500 mt-6 mb-3">Changes to Terms</h2>
        <p className="text-gray-700 mb-4">
