  ...
  return (
    <div className="flex items-center justify-center">
      <div className="w-full container mx-auto p-6">
        ...
        <h2 className="text-xl font-semibold text-pink-500 mt-6 mb-2">Use of Service</h2>
        ...
        <h2 className="text-xl font-semibold text-pink-500 mt-6 mb-2">User Responsibilities</h2>
        <ul className="list-disc pl-6 text-gray-700 mb-4">
        ...
        <h2 className="text-xl font-semibold text-pink-500 mt-6 mb-2">Changes to Terms</h2>
        <p className="text-gray-700 mb-4">
