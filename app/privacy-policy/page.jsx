...
export default function PrivacyPolicy() {
  return (
    <div className="flex items-center justify-center">
      <div className="w-full container mx-auto __gapTop">
        ...
        <h2 className="text-xl font-semibold __secondary-text mt-6 mb-3">Information We Collect</h2>
        ...
        <h2 className="text-xl font-semibold __secondary-text mt-6 mb-3">How We Use Your Information</h2>
        <ul className="list-disc pl-6 text-gray-700 mb-4">
          <li>To provide and improve our health services.</li>
          <li>To communicate with you about your account and updates.</li>
          <li>To ensure security and prevent fraud.</li>
        </ul>
        <h2 className="text-xl font-semibold __secondary-text mt-6 mb-3">Your Rights</h2>
        <ul className="list-disc pl-6 text-gray-700 mb-4">
