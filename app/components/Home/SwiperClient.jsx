        ...
        {data?.home_page?.slides.map((slide, ind) => (
          <SwiperSlide key={ind}>
            <div className="bg-white">
              <div className="md:flex justify-between md:ml-[8%] xl:ml-[12%] h-auto relative z-0">
                ...
                <div className="relative z-[100] pb-[100px] xl:pb-0">
                  <div className="w-full mt-[65px] md:mt-[80px] px-6 md:px-0">
                    ...
                    <Button
                      variant="outline"
                      className="cursor-pointer __secondary-bg text-white __text mt-4"
                    >
                ...
                {/* Right side image */}
                <div className="flex-1 h-[350px] overflow-hidden lg:h-full relative z-[-10] mt-[-15px] lg:-mt-3">
                  <Image
                    src={slide?.image || ""}
                    alt={`hero image ${ind}`}
                    width={650}
              ...
              {/* Features */}
              <div className="__primary-bg mt-[-38px] md:mt-[-30px] xl:mt-[-85px] py-6 sm:py-8 md:py-14 md:rounded-2xl lg:rounded-3xl overflow-hidden relative z-20 container mx-auto">
